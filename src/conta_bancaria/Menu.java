...
public class Menu {
	...
	public static void main(String[] args) {
		...
		// Instânciando um Objeto da CLasse Conta Corrente
		ContaCorrente cc1 = new ContaCorrente(2, 456, 1, "Fernanda Murched", 600000, 60000);
		cc1.visualizar();
		cc1.sacar(659000);
		cc1.visualizar();
		cc1.depositar(50000);
		...
		ContaPoupanca cp1 = new ContaPoupanca(5, 822, 2, "Thais", 500000, 29);
		cp1.visualizar();
		cp1.sacar(5000);
		cp1.visualizar();
		cp1.depositar(10000);
